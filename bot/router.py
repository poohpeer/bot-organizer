...
_ACTIVE_MODE_SYSTEM_INSTRUCTION = (
    ...
    "adding=true only when they asked for MORE of something rather than "
    "saying how much there should be, so \"добавь ещё бутылку\" is "
    "adding=true and \"должно быть 700 г\" is not. "
