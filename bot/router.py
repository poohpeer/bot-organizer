...
_ACTIVE_MODE_SYSTEM_INSTRUCTION = (
    ...
    "instead. If list_add answers amount_already_set, the item already has "
    "an amount and nothing was changed: say what is on the list and ask for "
    "the new total rather than the difference — \"уже есть 1 ящ. пива; если "
    "нужно больше, скажи, сколько всего\". When they answer with the whole "
    "amount, pass it as amounts, which replaces what is stored: \"ящик и две "
    "бутылки\" is amounts=[{amount:1,unit:\"ящик\"},{amount:2,unit:\"бутылка\"}]. When someone says they will bring something, call list_claim with "
